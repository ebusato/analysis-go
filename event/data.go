...
func (d *Data) PlotPulses(xaxis pulse.XaxisType, onlyClustersWithSig bool, yrange pulse.YRange, xrange pulse.XRange) {
	for i := range d.Events {
		d.Events[i].PlotPulses(xaxis, onlyClustersWithSig, yrange, xrange)
		if i >= 40 {
			break
		}
	}
